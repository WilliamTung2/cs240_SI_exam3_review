 ...
 * 
 * 9. Components:
 *       a. Kruskal's uses a min heap of edge weights
 *       b. Prim's uses sets of vertices
 *       c. Prim's starts at one node and works outwards
 *       d. Kruskal's jumps around from lowest edge to lowest edge
 * 
 */